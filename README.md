...
The app will let a reviewer launch a synthetic incident, watch specialized agents coordinate through Band, inspect the legal and technical findings that gate communications, review draft messages, notify or escalate human owners, and approve or simulate outbound communications. Supabase stores the incident record, agent outputs, notification attempts, decisions, and audit events so the workflow can be replayed and explained.

See [docs/product/project-vision.md](./docs/product/project-vision.md), [docs/product/build-plan.md](./docs/product/build-plan.md), [docs/product/pre-development-readiness.md](./docs/product/pre-development-readiness.md), [docs/product/master-implementation-guide.md](./docs/product/master-implementation-guide.md), [docs/product/phased-delivery-plan.md](./docs/product/phased-delivery-plan.md), [docs/product/interaction-and-notification-model.md](./docs/product/interaction-and-notification-model.md), and [docs/research/exa-generic-incident-research.md](./docs/research/exa-generic-incident-research.md) for the project vision, product scope, pre-development readiness, agent operating model, phased delivery plan, interaction/notification model, MVP boundaries, and Exa-backed generic incident research.
...
See [ONBOARDING.md](./ONBOARDING.md), [AGENTS.md](./AGENTS.md), [PRODUCTION_STACK_STANDARD.md](./PRODUCTION_STACK_STANDARD.md), [docs/platform-support.md](./docs/platform-support.md), [docs/collaboration/skills-and-rules.md](./docs/collaboration/skills-and-rules.md), [docs/collaboration/project-playbooks.md](./docs/collaboration/project-playbooks.md), [docs/product/project-vision.md](./docs/product/project-vision.md), [docs/product/build-plan.md](./docs/product/build-plan.md), [docs/product/generic-incident-backend-roadmap.md](./docs/product/generic-incident-backend-roadmap.md), [docs/product/pre-development-readiness.md](./docs/product/pre-development-readiness.md), [docs/product/master-implementation-guide.md](./docs/product/master-implementation-guide.md), [docs/product/phased-delivery-plan.md](./docs/product/phased-delivery-plan.md), [docs/product/interaction-and-notification-model.md](./docs/product/interaction-and-notification-model.md), [docs/product/decision-guardrails-questionnaire.md](./docs/product/decision-guardrails-questionnaire.md), [docs/product/crisis-signal-model.md](./docs/product/crisis-signal-model.md), [docs/architecture/system-architecture.md](./docs/architecture/system-architecture.md), [docs/architecture/business-integration-plan.md](./docs/architecture/business-integration-plan.md), [docs/architecture/agent-implementation-plan.md](./docs/architecture/agent-implementation-plan.md), [docs/architecture/partner-implementation-requirements.md](./docs/architecture/partner-implementation-requirements.md), [docs/design/final-ui-ux-brief.md](./docs/design/final-ui-ux-brief.md), [docs/design/ui-design-mockups.md](./docs/design/ui-design-mockups.md), [docs/design/live-data-ui-components.md](./docs/design/live-data-ui-components.md), [docs/design/figma-repair-spec.md](./docs/design/figma-repair-spec.md), [docs/design/ui-page-plan.md](./docs/design/ui-page-plan.md), [docs/design/command-room-page-plan.md](./docs/design/command-room-page-plan.md), [docs/design/ui-color-system.md](./docs/design/ui-color-system.md), [docs/demo/demo-day-failure-plan.md](./docs/demo/demo-day-failure-plan.md), [docs/compliance/trigger-model.md](./docs/compliance/trigger-model.md), [docs/research/exa-generic-incident-research.md](./docs/research/exa-generic-incident-research.md), [docs/research/skepticism-audit.md](./docs/research/skepticism-audit.md), [docs/research/research-roadmap.md](./docs/research/research-roadmap.md), [docs/research/competitive-ui-notes.md](./docs/research/competitive-ui-notes.md), [docs/research/competitor-landscape.md](./docs/research/competitor-landscape.md), [docs/research/technology-partners.md](./docs/research/technology-partners.md), [docs/presentation/README.md](./docs/presentation/README.md), [docs/api/README.md](./docs/api/README.md), [docs/api/live-data-apis.md](./docs/api/live-data-apis.md), [docs/api/notification-apis.md](./docs/api/notification-apis.md), and [docs/architecture/engineering-playbook.md](./docs/architecture/engineering-playbook.md) for setup, stack, platform support, collaboration rules, portable playbooks, product scope, pre-development readiness, generic incident routing, master implementation, phased delivery, interaction and notification behavior, decision guardrails, crisis signal intake, architecture, business integration, final UI/UX direction, UI mockups, live-data UI placement, Figma repair, page planning, color tokens, demo fallback, agent implementation, partner requirements, compliance signals, Exa-backed generic incident research, skepticism audit, competitive research, technology partners, presentation planning, API details, live-data APIs, notification APIs, and the project build approach.
...
- Exa research pass over NIST SP 800-61r3, CISA incident response guidance, Cortex XSOAR, Splunk SOAR, GDPR, SEC, and HIPAA sources

See [docs/research/hackathon-research.md](./docs/research/hackathon-research.md) and [docs/research/exa-generic-incident-research.md](./docs/research/exa-generic-incident-research.md).
