...
See [docs/product/project-vision.md](./docs/product/project-vision.md), [docs/product/build-plan.md](./docs/product/build-plan.md), [docs/product/pre-development-readiness.md](./docs/product/pre-development-readiness.md), [docs/product/master-implementation-guide.md](./docs/product/master-implementation-guide.md), [docs/product/phased-delivery-plan.md](./docs/product/phased-delivery-plan.md), and [docs/product/interaction-and-notification-model.md](./docs/product/interaction-and-notification-model.md) for the project vision, product scope, pre-development readiness, agent operating model, phased delivery plan, interaction/notification model, MVP boundaries, and research status.
