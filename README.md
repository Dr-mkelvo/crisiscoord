...
See [ONBOARDING.md](./ONBOARDING.md), [PRODUCTION_STACK_STANDARD.md](./PRODUCTION_STACK_STANDARD.md), and [docs/api/README.md](./docs/api/README.md) for setup, stack, and API details.
