...
See [docs/product/project-vision.md](./docs/product/project-vision.md), [docs/product/build-plan.md](./docs/product/build-plan.md), [docs/product/master-implementation-guide.md](./docs/product/master-implementation-guide.md), and [docs/product/phased-delivery-plan.md](./docs/product/phased-delivery-plan.md) for the project vision, product scope, agent operating model, phased delivery plan, MVP boundaries, and research status.
...
See [ONBOARDING.md](./ONBOARDING.md), [AGENTS.md](./AGENTS.md), [PRODUCTION_STACK_STANDARD.md](./PRODUCTION_STACK_STANDARD.md), [docs/platform-support.md](./docs/platform-support.md), [docs/collaboration/skills-and-rules.md](./docs/collaboration/skills-and-rules.md), [docs/collaboration/project-playbooks.md](./docs/collaboration/project-playbooks.md), [docs/product/project-vision.md](./docs/product/project-vision.md), [docs/product/build-plan.md](./docs/product/build-plan.md), [docs/product/master-implementation-guide.md](./docs/product/master-implementation-guide.md), [docs/product/phased-delivery-plan.md](./docs/product/phased-delivery-plan.md), [docs/product/decision-guardrails-questionnaire.md](./docs/product/decision-guardrails-questionnaire.md), [docs/product/crisis-signal-model.md](./docs/product/crisis-signal-model.md), [docs/architecture/system-architecture.md](./docs/architecture/system-architecture.md), [docs/architecture/business-integration-plan.md](./docs/architecture/business-integration-plan.md), [docs/architecture/agent-implementation-plan.md](./docs/architecture/agent-implementation-plan.md), [docs/architecture/partner-implementation-requirements.md](./docs/architecture/partner-implementation-requirements.md), [docs/design/ui-page-plan.md](./docs/design/ui-page-plan.md), [docs/design/command-room-page-plan.md](./docs/design/command-room-page-plan.md), [docs/design/ui-color-system.md](./docs/design/ui-color-system.md), [docs/demo/demo-day-failure-plan.md](./docs/demo/demo-day-failure-plan.md), [docs/compliance/trigger-model.md](./docs/compliance/trigger-model.md), [docs/research/skepticism-audit.md](./docs/research/skepticism-audit.md), [docs/research/research-roadmap.md](./docs/research/research-roadmap.md), [docs/research/competitive-ui-notes.md](./docs/research/competitive-ui-notes.md), [docs/research/competitor-landscape.md](./docs/research/competitor-landscape.md), [docs/research/technology-partners.md](./docs/research/technology-partners.md), [docs/presentation/README.md](./docs/presentation/README.md), [docs/api/README.md](./docs/api/README.md), and [docs/architecture/engineering-playbook.md](./docs/architecture/engineering-playbook.md) for setup, stack, platform support, collaboration rules, portable playbooks, product scope, master implementation, phased delivery, decision guardrails, crisis signal intake, architecture, business integration, UI page planning, color tokens, demo fallback, agent implementation, partner requirements, compliance signals, skepticism audit, competitive research, technology partners, presentation planning, API details, and the project build approach.
