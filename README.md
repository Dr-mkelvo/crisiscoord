...
See [docs/product/project-vision.md](./docs/product/project-vision.md), [docs/product/build-plan.md](./docs/product/build-plan.md), and [docs/product/phased-delivery-plan.md](./docs/product/phased-delivery-plan.md) for the project vision, product scope, phased delivery plan, MVP boundaries, and research status.
